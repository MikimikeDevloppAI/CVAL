    ...
    <div className="w-full space-y-6">
      ...
      <div className="bg-card/50 backdrop-blur-xl border border-border/50 shadow-lg rounded-xl p-6">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="inline-flex items-center gap-6 px-6 py-3 bg-gradient-to-br from-background via-card to-card/50 backdrop-blur-xl border-2 border-primary/20 rounded-xl text-sm font-medium text-foreground">
