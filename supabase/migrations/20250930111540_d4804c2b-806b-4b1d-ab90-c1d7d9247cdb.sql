-- Mettre à jour les fonctions pour utiliser le site "Clinique La Vallée - Bloc opératoire" pour tous les besoins de bloc opératoire
...
BEGIN
  ...
  WHILE v_current_date <= v_end_date LOOP
    ...
    -- Generate for bloc operatoire avec le site spécifique
    FOR v_bloc IN
...
-- Mettre à jour la fonction create_besoin_from_bloc
