-- Fix the condition to properly detect full-day vs partial-day absences
-- A full-day absence has BOTH heure_debut AND heure_fin as NULL
-- A partial-day absence has BOTH heure_debut AND heure_fin filled
...
-- Same fix for generate_besoin_effectif
