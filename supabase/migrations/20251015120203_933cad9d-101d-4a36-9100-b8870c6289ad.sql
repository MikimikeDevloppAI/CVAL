-- Drop and recreate the swap_secretaries_personnel function to also swap responsibilities
...
DECLARE
  ...
  v_temp_site_id UUID;
  v_temp_is_1r BOOLEAN;
  v_temp_is_2f BOOLEAN;
  v_temp_is_3f BOOLEAN;
BEGIN
  ...
  -- Store assignment 1 values
  v_temp_site_id := v_assignment_1.site_id;
  v_temp_is_1r := v_assignment_1.is_1r;
  v_temp_is_2f := v_assignment_1.is_2f;
  v_temp_is_3f := v_assignment_1.is_3f;
  
  -- Check if assignment 1 is part of a full day
  ...
  -- Perform the swaps (site AND responsibilities)
  IF v_is_full_day_1 AND v_is_full_day_2 THEN
    ...
    SET 
      site_id = v_assignment_2.site_id,
      is_1r = v_assignment_2.is_1r,
      is_2f = v_assignment_2.is_2f,
      is_3f = v_assignment_2.is_3f
    WHERE id IN (v_morning_id_1, v_afternoon_id_1);
    
    UPDATE public.planning_genere_personnel
    SET 
      site_id = v_temp_site_id,
      is_1r = v_temp_is_1r,
      is_2f = v_temp_is_2f,
      is_3f = v_temp_is_3f
  ...
  ELSIF v_is_full_day_1 THEN
    -- Only assignment 1 is a full day: swap both periods with assignment 2
    UPDATE public.planning_genere_personnel
    SET 
      site_id = v_assignment_2.site_id,
      is_1r = v_assignment_2.is_1r,
