-- Fix besoins_sites_summary: count all assigned secretaries except bloc operatoire site
...
site_assignments AS (
  ...
  WHERE ce.actif = true
    ...
    AND s.nom != 'Clinique La Vallée - Bloc opératoire'  -- Exclude bloc operatoire site
