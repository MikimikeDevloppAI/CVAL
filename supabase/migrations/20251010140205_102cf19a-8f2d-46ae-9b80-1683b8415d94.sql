...
-- Remplacer alternance_semaine_reference (date) par alternance_semaine_modulo (integer)

-- Ajouter la colonne alternance_semaine_modulo
ALTER TABLE public.horaires_base_secretaires
ADD COLUMN alternance_semaine_modulo integer DEFAULT 0;

-- Supprimer l'ancienne colonne alternance_semaine_reference
ALTER TABLE public.horaires_base_secretaires
...
BEGIN
  ...
  WHILE v_current_date <= v_end_date LOOP
    ...
    -- Check if secretary should work according to alternance using week number
